...
public class ClienteMain{
	...
	public static void leerViajes(){
		try{
			...
			Viaje viaje2 = new ViajeIncentivo("Popayán", "Medellín", 2100000, new SimpleDateFormat("dd/MM/yyyy").parse("03/06/2019"), new SimpleDateFormat("dd/MM/yyyy").parse("09/06/2019"),"Emtel");
			viajes.add(viaje2);
	...
	public static void mostrarViajes(){
		//en este caso vemos que todos los viajes ejecutan el mismo metodo "descripcion()" diferente
		//ya que al ser este metodo abstracto en la clase padre, les forzamos a las clases hijas
		//que implementen ese metodo
