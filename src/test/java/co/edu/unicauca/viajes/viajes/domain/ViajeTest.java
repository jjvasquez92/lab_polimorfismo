...
public class ViajeTest {
    ...
    public void testViajeFamiliar() throws ParseException {
        ...
        assertEquals("Cualquier método implementado en la clase de base", viaje.cualquierMetodo());
    ...
    public void testViajeIncentivo() throws ParseException {
        ...
        assertEquals("Cualquier método implementado en la clase de base", viaje.cualquierMetodo());
        assertEquals("Método implementado en la clase hija de incentivo", viaje.cualquierMetodo2());
    }
    ...
    public void testViajeIndividual() throws ParseException {
        ...
        assertEquals("Cualquier método implementado en la clase de base", viaje.cualquierMetodo());
        assertEquals("Cualquier método2 implementado en la clase de base", viaje.cualquierMetodo2());
